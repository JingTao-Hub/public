...
export default class jigsaw {
    ...
    initDOM() {
        ...
        const canvasContext = createElement('div', 'canvas-context')
        ...
        canvasContext.appendChild(refreshIcon)
        canvasContext.appendChild(canvas)
        canvasContext.appendChild(block)
        // el.appendChild(refreshIcon)
        el.appendChild(canvasContext)
    ...
    bindEvents() {
        ...
        const handleDragMove = (e) => {
            ...
            this.sliderMask.style.width = moveX+30 + 'px'
            trail.push(moveY)
        }
